...
const ReconnectTitle = () => (
    <Text>
      ...
      <Text style={{ fontFamily: 'Poppins-Bold', fontSize: 18 }}> 반려동물과 작별하기</Text>
    </Text>
  );

const ReconnectStack = () => 
<ReconnectStacks.Navigator screenOptions={{headerTitleAlign:"center",}}>
    <ReconnectStacks.Screen name = 'ReconnectProfile' component={ReconnectScreen} options={{headerTitle: () => <ReconnectTitle/>}} />
