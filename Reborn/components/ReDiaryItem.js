...
const ReDiaryItem = ({ rediaryId, rediaryCreatedAt, rediaryTitle, rediaryContent, pickEmotion, resultEmotion, navigation} ) => {
    let backgroundImage;
    ...
    return (
      <TouchableOpacity onPress={() => navigation.navigate('RediaryStack', {screen: "RediaryModify", params: {rediaryId, rediaryTitle,rediaryCreatedAt, rediaryContent, pickEmotion, resultEmotion}})}>
        <View style={styles.item}>
            <ImageBackground style={styles.backgroundImage} source={backgroundImage}>
              <View style={styles.container}>
                  <Image source={weatherImages[pickEmotion]} style={styles.image} />
                  <Text style={styles.date}>{rediaryTitle} {'\n'}{rediaryCreatedAt} </Text>
